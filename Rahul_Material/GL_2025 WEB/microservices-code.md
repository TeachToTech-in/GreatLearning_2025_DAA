byRahul# Debugging Guide - Microservices - V2
...
(4) Check if you have the right repository url in /spring-cloud-config-server/src/main/resources/application.properties - spring.cloud.config.server.git.uri=file:///byRahul/git/spring-micro-services/03.microservices/git-localconfig-repo
...
- Group Id: com.byRahul.microservices
...
#### /limits-service/src/main/java/com/byRahul/microservices/limitsservice/bean/Limits.java New

```java
package com.byRahul.microservices.limitsservice.bean;
...
#### /limits-service/src/main/java/com/byRahul/microservices/limitsservice/controller/LimitsController.java New

```java
package com.byRahul.microservices.limitsservice.controller;

import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.RestController;

import com.byRahul.microservices.limitsservice.bean.Limits;
...
#### /limits-service/src/main/java/com/byRahul/microservices/limitsservice/configuration/Configuration.java New

```java
package com.byRahul.microservices.limitsservice.configuration;
...
#### /limits-service/src/main/java/com/byRahul/microservices/limitsservice/controller/LimitsController.java Modified
...
import com.byRahul.microservices.limitsservice.bean.Limits;
import com.byRahul.microservices.limitsservice.configuration.Configuration;
...
#### /spring-cloud-config-server/src/main/java/com/byRahul/microservices/springcloudconfigserver/SpringCloudConfigServerApplication.java Modified
...
spring.cloud.config.server.git.uri=file:///byRahul/git/spring-microservices-v2/03.microservices/git-localconfig-repo
...
#### /currency-exchange-service/src/main/java/com/byRahul/microservices/currencyexchangeservice/CurrencyExchange.java New

```java
package com.byRahul.microservices.currencyexchangeservice;
...
#### /currency-exchange-service/src/main/java/com/byRahul/microservices/currencyexchangeservice/CurrencyExchangeController.java New
...
#### /currency-exchange-service/src/main/java/com/byRahul/microservices/currencyexchangeservice/CurrencyExchange.java Modified 
...
- Complete debugging guide for problems with JPA and Hibernate: https://github.com/byRahul/byRahul-initiatives/blob/master/The-byRahul-TroubleshootingGuide-And-FAQ/jpa-and-hibernate.md#tables-are-not-created
...
#### /currency-exchange-service/src/main/java/com/byRahul/microservices/currencyexchangeservice/CurrencyExchangeController.java Modified
...
#### /currency-exchange-service/src/main/java/com/byRahul/microservices/currencyexchangeservice/CurrencyExchangeRepository.java New
...
#### /currency-conversion-service/src/main/java/com/byRahul/microservices/currencyconversionservice/CurrencyConversionController.java New

```java
package com.byRahul.microservices.currencyconversionservice;
...
#### /currency-conversion-service/src/main/java/com/byRahul/microservices/currencyconversionservice/CurrencyConversion.java New
...
#### /currency-conversion-service/src/main/java/com/byRahul/microservices/currencyconversionservice/CurrencyConversionController.java Modified
...
(1) Ensure that you have the annotation @EnableFeignClients with right packages on the class public class CurrencyConversionServiceApplication @EnableFeignClients("com.byRahul.microservices.currencyconversionservice")
...
#### /currency-conversion-service/src/main/java/com/byRahul/microservices/currencyconversionservice/CurrencyExchangeProxy.java New
...
#### /naming-server/src/main/java/com/byRahul/microservices/namingserver/NamingServerApplication.java Modified

- Add @EnableEurekaServer


```java
package com.byRahul.microservices.namingserver;
...
#### /currency-conversion-service/src/main/java/com/byRahul/microservices/currencyconversionservice/CurrencyExchangeProxy.java Modified
...
#### /api-gateway/src/main/java/com/byRahul/microservices/apigateway/ApiGatewayConfiguration.java New

```java
package com.byRahul.microservices.apigateway;
...
#### /api-gateway/src/main/java/com/byRahul/microservices/apigateway/LoggingFilter.java New
...
#### /currency-exchange-service/src/main/java/com/byRahul/microservices/currencyexchangeservice/CircuitBreakerController.java New
...
- (5 Docker Compose Backup Files)[https://github.com/byRahul/spring-microservices-v2/tree/main/04.docker/backup]
